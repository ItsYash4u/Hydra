    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station_name', models.CharField(blank=True, default='', max_length=255, verbose_name='Station Name')),
                ('user_type', models.CharField(blank=True, default='', max_length=50, verbose_name='Type of User')),
            ...
            managers=[
                ('objects', greeva.users.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='OTP',
