...
// Suppress verbose console messages as requested
(function () {
    // Hide verbose/debug/info logs to keep console clean for user
    try {
        if (window.console && console.debug) window.console.debug = function () { };
        if (window.console && console.log) window.console.log = function () { };
        if (window.console && console.info) window.console.info = function () { };
    } catch (e) { }
})();

(function () {
    var savedConfig = sessionStorage.getItem("__GREEVA_CONFIG__");
