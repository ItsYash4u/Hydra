...
var dailySalesColors = ["#6b5eae", "#31ce77", "#fa5c7c", "#fbcc5c"];
var dailySalesDataColors = $("#daily-sales").data('colors');
if (dailySalesDataColors) {
    dailySalesColors = dailySalesDataColors.split(",");
}
...
//
///
var statColors = ["#6b5eae", "#31ce77", "#fa5c7c", "#fbcc5c"];
var statDataColors = $("#statistics-chart").data('colors');
if (statDataColors) {
    statColors = statDataColors.split(",");
}
...
//
///
var revenueColors = ["#6b5eae", "#31ce77", "#fa5c7c", "#fbcc5c"];
var revenueDataColors = $("#revenue-chart").data('colors');
if (revenueDataColors) {
    revenueColors = revenueDataColors.split(",");
}
...
// data-visits- CHART
//
var visitsColors = ["#6b5eae", "#35b8e0", "#31ce77", "#fa5c7c", "#e3eaef"];
var visitsDataColors = $("#data-visits-chart").data('colors');
if (visitsDataColors) {
    visitsColors = visitsDataColors.split(",");
}
...
if (document.querySelector("#data-visits-chart")) {
    var chart = new ApexCharts(
...
class VectorMap {
    ...
    // World Map Markers with Line
    initWorldMarkerLine() {
        if (!document.querySelector("#world-map-markers-line")) return;
